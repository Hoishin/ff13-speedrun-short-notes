...
\begin{menu}
	...
	\begin{tabular}{cccl}
		...
		\chrole{\rav} & \rav          & \rav          &          \\
		\rav          & \chrole{\rav} & \chrole{\sab} & \default \\
		\rav          & \rav          & \med          &          \\
		\rav          & \chrole{\rav} & \sab          &          \\
		\com          & \com          & \rav          &
	\end{tabular}
...
\end{menu}
\begin{mainlist}
	\item \skips{2}|\skip|Grab \textbf{Ethersol}|Use \textbf{Fortisol}, \textbf{Aegisol} and \textbf{Ethersol}|\skip
\end{mainlist}
\begin{fight}{Barthandelus 2}
	...
	\item [1] \com/\com/\med: \textbf{Repeat} \to Refresh with [6] and [4]|\skip|\skip|\skips{2}|\save
\end{fight}
